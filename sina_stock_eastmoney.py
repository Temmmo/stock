...
curdor={}
def stock_I(num):
    filename = "/home/yutuo/stockdata/东方财富股吧/" + str(num).zfill(6)
    if os.path.exists(filename):
        os.chdir("/home/yutuo/stockdata/东方财富股吧/" + str(num).zfill(6))
        #print "file exits"
        ...
        filename_txt="/home/yutuo/stockdata/东方财富股吧/"+str(num).zfill(6)+"/file_big.txt"
        r=0
        with open(filename_txt, 'r')as fp:
            allLines = fp.readlines()
            #print "file lines count:",len(allLines)
        while r < len(allLines)-12:       #处理 大文件
