...
def stock_I(num):
    ...
    if os.path.exists(filename):
        os.chdir("/home/yutuo/downloads/teacherdata/股票贴吧数据/新浪股吧/" + str(num).zfill(6))
        print "file exits"
        ...
        filename_txt="/home/yutuo/downloads/teacherdata/股票贴吧数据/新浪股吧/"+str(num).zfill(6)+"/file_big.txt"
        r=0
